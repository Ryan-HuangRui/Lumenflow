...
from ..backends.darktable import codec as darktable_codec
from ..backends.rawtherapee import pp3 as rawtherapee_pp3
from ..execution import render as render_raw
from . import preview as preview_provider
from .raw_extensions import RAW_EXTENSIONS
...
def validate_edit_intent(intent: dict[str, Any]) -> None:
    ...
    if Path(source["path"]).suffix.lower() not in RAW_EXTENSIONS:
