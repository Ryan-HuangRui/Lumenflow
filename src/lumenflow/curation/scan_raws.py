"""Scan RAW files and normalize editor selection metadata.

The scanner is deliberately read-only.  It understands the sidecar formats
used by the first Lumenflow workflow and returns deterministic metadata for
...
__all__ = [
    ...
    "is_selected",
    "main",
    "normalize_color_labels",
    "parse_darktable_xmp",
    "parse_int",
    "parse_rawtherapee_pp3",
