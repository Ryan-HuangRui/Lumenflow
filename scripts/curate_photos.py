...
The script owns deterministic operations only: RAW discovery, metadata/date
filtering, embedded-preview extraction, contact sheets, plan validation, and
packaging. Visual selection and sequencing remain the host agent's job.
"""
...
from lumenflow_config import read_local_config, resolve_photo_output_dir
